...
class PaymentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Payment
        fields = "__all__"  # include all, then override with read_only
        read_only_fields = ["invoice_number", "payment_reference"]
...
class ApplicationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = "__all__"
        read_only_fields = ["applicant", "status", "assigned_to", "submitted_at","reference_number"]        
...
class AssignRegistrarSerializer(serializers.Serializer):
    ...
    def validate_registrar_id(self, value):
        try:
            ...
            raise serializers.ValidationError("Registrar not found or not valid.")
        return registrar
